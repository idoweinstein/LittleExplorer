...
CREATE TABLE `kindergarten` (
  ...
  CONSTRAINT `FK_teacher_id` FOREIGN KEY (`teacher_id`) REFERENCES `parent` (`parent_id`)
...
-- Dump completed on 2023-05-25 13:53:59
